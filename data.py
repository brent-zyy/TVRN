...
class PrecompDataset(data.Dataset):
    ...
    def __init__(self, data_path, data_split, vocab):
        ...
        self.IOU = np.load(loc + '%s_IOU_half.npy' % data_split)
    ...
    def __getitem__(self, index):
        ...
        return image, target, index, img_id,tokens, IOU, depend
...
def collate_fn(data):
    ...
    images, captions, ids, img_ids, tokens, Iou, depend = zip(*data)
    ...
    return images, targets, lengths, Iou, depend, ids, tokens
